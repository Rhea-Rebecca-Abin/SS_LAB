...
int main()
{
    ...
    int start, diff, i, address, add, len, actual_len, finaddr, prevaddr, j = 0,star;
    ...
    if (strcmp(opcode, "START") == 0)
    {
        ...
        fprintf(fp4, "H^%s^00%s^0000%x\n", label, operand, finaddr-star);
        fscanf(fp3, "%d%s%s%s", &address, label, opcode, operand);
        start = address;
        diff = prevaddr - start;
        fprintf(fp4, "T^00%d^%x", address, diff);
    }
...
The Assembly listing :
	...
	**	START	2000
2000	**	LDA	FIVE	002018
2003	**	STA	ALPHA	0C2012
2006	**	LDCH	CHARZ	502021
2009	**	STCH	C1	542022
2012	ALPHA	RESW	2
...
H^**^002000^000017
T^002000^16^002018^0C2012^502021^542022^000005^00005A
E^002000
*/
